...
class AccessPathTest < Minitest::Test
  def test_path
  	...
  	path = LibraClient::AccountConfig.account_sent_event_path
	access_path0 = LibraClient::AccessPath.new(address_hex, path).to_proto
	address = LibraClient::AccountAddress.hex_to_bytes(address_hex)
